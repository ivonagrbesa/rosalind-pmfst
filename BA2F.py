...
def RandomMotifSearch(dna, k, t):
  ...
  while(True):
    ...
    motifs=[] #ovdi cemo spremat nove izgenerirane motive i posli ih provjerit
    for i in range(0, t):
...
#konacno mnogo (N) puta vrtimo trazenje najboljih motiva
def RandomizedMotifSearch(dnalist, k, N=1000):
  bestmotifs=RandomMotifSearch(dnalist, k, t)
  for i in range(1, N):
    motifs=RandomMotifSearch(dnalist, k, t)
